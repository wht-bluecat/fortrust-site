      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              <div>
                ...
                <span className="block text-[10px] text-navy-400 font-medium uppercase tracking-wider">
                  Education Services
                </span>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-1.5">
              {offices.map((office) => (
                <li key={office.name} className="text-xs text-navy-400">
                  <span className="font-medium text-navy-300">{office.name}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-navy-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/privacy" className="text-xs text-navy-400 hover:text-brand-300 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-xs text-navy-400 hover:text-brand-300 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
