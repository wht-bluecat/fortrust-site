...
const destinations = [
  {
    ...
    schools: "120+", tuition: "From PHP 400,000/year",
  },
  {
    ...
    schools: "80+", tuition: "From PHP 500,000/year",
  },
  {
    ...
    schools: "40+", tuition: "From PHP 350,000/year",
  },
  {
    ...
    schools: "60+", tuition: "From PHP 600,000/year",
  },
];
...
export default function DestinationsPage() {
  return (
    <>
      <PageHero
        title={<>Where do you want to <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-cyan-300">study?</span></>}
