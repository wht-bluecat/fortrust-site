              ...
              <div>
                ...
                <form className="mt-8 space-y-5">
                  ...
                  <div>
                    ...
                    <select id="subject" className="block w-full rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all outline-none">
                  ...
                  <div>
                    ...
                    <textarea id="message" rows={5} className="block w-full rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all outline-none" />
                  </div>
                  <button type="submit" className="cta-shine w-full rounded-full bg-brand-500 px-8 py-4 text-base font-bold text-white hover:bg-brand-600 hover:shadow-lg transition-all duration-200 shadow-[0_8px_24px_-6px_rgba(242,107,33,0.5)]">
                    Send Message
                  </button>
                </form>
              </div>
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1">
                        <a href="tel:+639178224448" className="text-brand-500 hover:text-brand-600 font-medium text-sm">0917 822 4448</a>
                        {" / "}
                        <a href="tel:+639175600066" className="text-brand-500 hover:text-brand-600 font-medium text-sm">0917 560 0066</a>
                      </p>
                      <p className="mt-0.5">
                        <a href="tel:+6285512542" className="text-brand-500 hover:text-brand-600 font-medium text-sm">(02) 8551 2542</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1">
                        <a href="mailto:admin@fortrust.ph" className="text-brand-500 hover:text-brand-600 font-medium text-sm">admin@fortrust.ph</a>
                      </p>
                      <p className="mt-0.5">
                        <a href="mailto:philippines@fortrust.com" className="text-brand-500 hover:text-brand-600 font-medium text-sm">philippines@fortrust.com</a>
                      </p>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <p className="mt-2">
                        <a
                          ...
                          className="inline-flex items-center gap-2 rounded-full bg-brand-50 px-4 py-2.5 text-sm font-medium text-brand-600 hover:bg-brand-100 transition-colors"
                        >
